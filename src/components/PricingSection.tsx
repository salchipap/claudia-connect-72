    ...
    <section id="pricing" className="py-24 px-6 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Planes que se adaptan a tus necesidades</h2>
        ...
        <div className="mt-12 text-center text-muted-foreground">
          ...
          <p className="mt-1">
            <button 
              onClick={() => handlePricingClick('Personalizado')}
              className="text-claudia-primary hover:underline font-medium"
            >
